...
<head>
    ...
    <title>Config super admins</title>
    <!-- Bootstrap core CSS-->
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <br><br>
                <i></i>Edit super admin</div>
            <div class="card-header">
                <div class="card-body">
                    <form action="/configSuperAdmins", method="get">
                        <table id="myAreaChart" width="100%">

                            <tr>
                                <td>Change to new login:<br>
                                    <input type="text" name="newLogin" placeholder="login"></td>
                            </tr>
                            <tr>
                                <td>Change to new password:<br>
                                    <input type="text" name="newPassword" placeholder="password"></td>
                            </tr>
