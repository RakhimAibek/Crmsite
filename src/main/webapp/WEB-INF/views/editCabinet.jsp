    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <br><br>
                <i class="fa fa-table"></i> All active cabinets:</div>
            <div class="card-body">
                        ...
                        <%
                            ...
                            if(cabinetsList!=null){
                                ...
                                for (Cabinets cabinet: cabinetsList){
                                    if (cabinet.getActive()==1) {
                        %>

                        <tr>
                            <td><% out.print(cabinet.getName());%></td>

                            <td><% out.print(cabinet.getDescription());%></td>

                            <form action="/deleteCabinet", method="post">
                                <td>
                                    <input type="hidden" value="<%out.print(cabinet.getId());%>" name="cabinetId"/>
                                    <input type="submit" value="DELETE">
                                </td>
                            </form>
                            <form action="/editCabinet", method="post">
                                <td>
                                    <input type="hidden" value="<%out.print(cabinet.getId());%>" name="cabinetId"/>
