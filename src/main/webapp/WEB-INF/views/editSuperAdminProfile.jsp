    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <br><br>
                <i></i>Editing my profile data</div>
                    <div class="card-header">
                        <div class="card-body">
                            <form action="/editSuperAdminProfile", method="post">
                                 <table id="myAreaChart" width="100%">
                                     <tr>
                                         <td>Change login to:<br>
                                             <input type="text" name="newLogin" placeholder="login" value="<%request.getParameter("newLogin");%>"></td>
                                     </tr>

                                     <tr>
                                         <td>Change password to:<br>
                                             <input type="text" name="newPassword" placeholder="password" value="<%request.getParameter("newPassword");%>"></td>
                                     </tr>

                                     <tr>
                                         <td>Verify with your password:<br>
                                             <input type="text" name="oldPassword" placeholder="current password"></td>
                                     </tr>
