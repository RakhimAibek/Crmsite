    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <br><br>
                <i class="fa fa-table"></i> All groups:</div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                        <%
                            List<Courses> allCoursesList = (List<Courses>)request.getAttribute("allCourseList");
                            Users user = (Users) session.getAttribute("adminSession");

                            if(allCoursesList!=null){

                                for (Courses c: allCoursesList){
                                    if (c.getActive()==1 && c.getCabinet_id().getName().equals(user.getCabinet_id().getName())) {
                        %>
                        ...
                        <tr>
                            ...
                            <form action="/deleteCourse", method="post">
                                <td>
                                    <input type="hidden" value="<%out.print(c.getId());%>" name="courseId"/>
                                    <input type="submit" value="DELETE">
                                </td>
                            </form>

                            <form action="/redirectEditCourse", method="get">
                                <td>
                                    <input type="hidden" value="<%out.print(c.getId());%>" name="courseId"/>
