    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <br><br>
                <i class="fa fa-table"></i> All students and teachers:</div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <%
                            ...
                            if(teacherAndStudentList!=null){
                                for (Users s: teacherAndStudentList){
                        %>
                        ...
                        <tr>
                            ...
                            <form action="/assignUser4Course", method="post">
                                <td>
                                    <input type="text" value="<%out.print(course.getId());%>" name="courseId"/>
                                    <input type="text" value="<%out.print(s.getId());%>" name="userId"/>
