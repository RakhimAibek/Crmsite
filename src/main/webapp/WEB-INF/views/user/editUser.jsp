...
<head>
    ...
    <title>Edit teacher/student profile</title>
    <!-- Bootstrap core CSS-->
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <br><br>
                <i class="fa fa-table"></i> All teachers and students:</div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                        <%
                            List<Users> teacherAndStudentList = (List<Users>)request.getAttribute("teacherAndStudentList");

                            if(teacherAndStudentList!=null){

                                for (Users u: teacherAndStudentList){
                                    if (u.getActive()==1) {
                        %>
                            ...
                            <tr>
                                ...
                                <td><% out.print(u.getCabinet_id().getName());%></td>

                                <td><% out.print(u.getRole_id().getName());%></td>

                                <form action="/deleteTeacherAndStudent", method="post">
                                    <td>
                                ...
                                <form action="/redirectUserEditPage", method="post">
                                    <td>
                                        <input type="hidden" value="<%out.print(u.getId());%>" name="userId"/>
