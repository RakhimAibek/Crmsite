                ...
                <div class="card-body">
                    <form action="/addLesson", method="post">
                        <table id="myAreaChart" width="100%">
                            ...
                            <tr>
                                <td>Title:<br>
                                    <input type="text" name="titleLesson" placeholder="title"></td>
                            </tr>

                            <tr>
                                <td>Content of the lesson:<br>
                                    <input type="text" name="contentLesson" placeholder="content"></td>
                            </tr>
                                ...
                                <td>Choose course:<br>
                                    ...
                                    <select name="courseName">
                                        <%
                                            ...
                                            {
                                                if (course.getCabinet_id().getName().equals(user.getCabinet_id().getName())) {
                                        %>

                                        <option value="<%out.print(course.getName());%>"><%out.print(course.getName());%></option>
                            ...
                            <tr>
                                <td><br><input type="submit" value="Add new lesson"></td>
                            </tr>
                        </table>
                    </form>
                </div>
