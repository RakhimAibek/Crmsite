                        ...
                        <table id="myAreaChart" width="100%">
                            ...
                            <tr>
                                <td>New login:<br>
                                    ...
                                    <input type="text" name="newLogin" value="<%out.print(user.getLogin());%>" placeholder="login"></td>
                            </tr>

                            <tr>
                                <td>New password:<br>
                                    <input type="password" name="newPassword" value="<%out.print(user.getPassword());%>" placeholder="password"></td>
                            </tr>

                            <tr>
                                <td>New name:<br>
                                    <input type="text" name="newName" value="<%out.print(user.getName());%>" placeholder="name"></td>
                            </tr>

                            <tr>
                                <td>New surname:<br>
                                    <input type="text" name="newSurname" value="<%out.print(user.getSurname());%>" placeholder="surname"></td>
                            </tr>
