            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                        <%
                            List<Groups> allGroupsList = (List<Groups>)request.getAttribute("allTechGroups");
                        ...
                        <tr>
                            ...
                            <td><% out.print(g.getCreated_date());%></td>

                            <form action="/allStudentsInMyGroup", method="get">
                                <td>
                                    <input type="hidden" value="<%out.print(g.getId());%>" name="groupId"/>
