                ...
                <div class="card-body">
                    <form action="/addCourse", method="post">
                        <table id="myAreaChart" width="100%">
                            ...
                            <tr>
                                <td>Name of course:<br>
                                    <input type="text" name="nameCourse" placeholder="name"></td>
                            </tr>

                            <tr>
                                <td>Description:<br>
                                    <textarea name="descCourse" placeholder="write description to the course"></textarea></td>
                            </tr>

                            <tr>
                                <td><br><input type="submit" value="Add group"></td>
                            </tr>
                        </table>
                    </form>
                </div>
