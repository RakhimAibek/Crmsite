                ...
                <div class="card-body">
                    <form action="/addPost", method="post">
                        <table id="myAreaChart" width="100%">
                            ...
                            <tr>
                                <td>Title:<br>
                                    <input type="text" name="titlePost" placeholder="title"></td>
                            </tr>

                            <tr>
                                <td>Content:<br>
                                    <input type="text" name="contentPost" placeholder="content"></td>
                            </tr>

                            <tr>
                                <td><br><input type="submit" value="Add post"></td>
                            </tr>
                        </table>
                    </form>
                </div>
