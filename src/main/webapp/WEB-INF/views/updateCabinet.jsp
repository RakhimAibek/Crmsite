...
<head>
    ...
    <title>Update existing cabinet</title>
    <!-- Bootstrap core CSS-->
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <br><br>
                <i></i>Update cabinet</div>
            <div class="card-header">
                <div class="card-body">
                    <form action="/updateCabinet", method="post">
                        <table id="myAreaChart" width="100%">

                            <tr>
                                <td>Change name:<br>
                                    <%Cabinets cabinet = (Cabinets) request.getAttribute("editedCabinet");%>
                                    <input type="text" name="cabinetId" value="<%out.print(cabinet.getId());%>">
                                    <input type="text" name="cabinetName" value="<%out.print(cabinet.getName());%>"></td>
                            </tr>
                            <tr>
                                <td>Change description:<br>
                                    <input type="text" name="cabinetDesc" value="<%out.print(cabinet.getDescription());%>"></td>
                            </tr>
