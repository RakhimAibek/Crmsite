...
<head>
    ...
    <title>Edit admins profile</title>
    <!-- Bootstrap core CSS-->
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <br><br>
                <i class="fa fa-table"></i> All active admins:</div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                        <%
                            List<Users> admins = (List<Users>)request.getAttribute("allAdmins");
                        ...
                        <tr>
                            <td><% out.print(admin.getLogin());%></td>

                            <td><% out.print(admin.getCabinet_id().getName());%></td>

                            <form action="/deleteAdmin", method="post">
                                <td>
                                    <input type="hidden" value="<%out.print(admin.getId());%>" name="adminId"/>
                                    <input type="submit" value="DELETE">
                                </td>
                            </form>

                            <form action="/redirectUpdatePage", method="post">
                                <td>
                                    <input type="hidden" value="<%out.print(admin.getId());%>" name="adminId"/>
